...
<recipetype:mekanism:reaction>.addRecipe("reaction/raw_irradium", <tag:items:enlightened_end:low_radioactive> * 3, <fluid:mekanism:sulfuric_acid> * 100, <gas:mekanism:uranium_oxide> * 400, 600, <item:enlightened_end:irradium_bar>, <gas:mekanism:nuclear_waste> * 200);
