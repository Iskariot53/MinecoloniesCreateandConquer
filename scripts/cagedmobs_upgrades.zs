...
<recipetype:create:mechanical_crafting>.addRecipe("cagedmobs.speed_ii_upgrade", <item:cagedmobs:speed_ii_upgrade>, [[<item:scguns:nether_star_fragment>, <item:cagedmobs:star_infused_netherite_ingot>, <item:scguns:nether_star_fragment>], [<tag:items:forge:storage_blocks/redstone>, <item:cagedmobs:speed_i_upgrade>, <tag:items:forge:storage_blocks/redstone>], [<tag:items:forge:storage_blocks/brass>, <tag:items:forge:storage_blocks/brass>, <tag:items:forge:storage_blocks/brass>]]);
