...
//REMOVING USELESS CHICKENS
		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromadamantium/bb_adamantium");
		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromdiamond/bb_adamantium");
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier8/sb_adamantium");
		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromadamantium/bb_titanium");
		<recipetype:chicken_roost:roost_output>.removeByName("chicken_roost:roost/tier8/roostv8_adamantium");
		<recipetype:chicken_roost:basic_breedingnew>.removeByName("chicken_roost:newbreeding/tier8/c_adamantium");
		
		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromtungsten/bb_tungstensteel");
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier7/sb_tungstensteel");
		<recipetype:chicken_roost:roost_output>.removeByName("chicken_roost:roost/tier7/roostv7_tungstensteel");
		
		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromrefinediron/bb_tungsten");
		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromtungsten/bb_tungsten");
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier6/sb_tungsten");
		<recipetype:chicken_roost:roost_output>.removeByName("chicken_roost:roost/tier6/roostv6_tungsten");
		
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier9/sb_titanium");
		<recipetype:chicken_roost:roost_output>.removeByName("chicken_roost:roost/tier9/roostv9_titanium");
		
		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromdiamond/bb_iridium");
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier8/sb_iridium");
		<recipetype:chicken_roost:roost_output>.removeByName("chicken_roost:roost/tier8/roostv8_iridium");
		
		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromaluminium/bb_chrome");
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier5/sb_chrome");
		<recipetype:chicken_roost:roost_output>.removeByName("chicken_roost:roost/tier5/roostv5_chrome");
		
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier8/sb_vibranium");
		
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier7/sb_allthemodium");

		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromuranium/bb_blutonium");
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier7/sb_blutonium");
		
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier6/sb_slimesteel");
		
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier6/sb_amethystbronze");
		
		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromiron/bb_quartzenrichediron");
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier5/sb_quartzenrichediron");
		
		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromcobald/bb_hepatizon");
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier6/sb_hepatizon");

		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier6/sb_knightslime");

		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromcobald/bb_cobald");
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier7/sb_cobald");

		<recipetype:chicken_roost:basic_breeding>.removeByName("chicken_roost:basicbreeding/fromcobald/bb_manyullyn");
		<recipetype:chicken_roost:soul_breeding>.removeByName("chicken_roost:soulbreeding/tier7/sb_manyullyn");
...
//FLUIX CRYSTAL CHICKEN
	//BREEDER
		<recipetype:chicken_roost:basic_breeding>.addJsonRecipe("basicbreeding.fluixcrystalchicken", {
		  "type": "chicken_roost:basic_breeding",
		  "ingredients": [
			{
			  "tag": "forge:seeds/tier7orup"
...
//CHARGED CERTUS QUARTZ CHICKEN
	//BREEDER
		<recipetype:chicken_roost:basic_breeding>.addJsonRecipe("basicbreeding.chargedcertuschicken", {
		  "type": "chicken_roost:basic_breeding",
		  "ingredients": [
			{
			  "tag": "forge:seeds/tier7orup"
